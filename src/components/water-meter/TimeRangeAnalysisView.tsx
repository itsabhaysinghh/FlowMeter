        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div className="space-y-1">
            <div className="flex items-center gap-2.5">
              <div className="p-2 rounded-xl bg-[#00B4D8]/10 border border-[#00B4D8]/20 text-[#00B4D8]">
      ...
      <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.05)] space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-3 py-2 text-xs font-bold text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00B4D8]/20 focus:border-[#00B4D8] cursor-pointer"
            >
              {devices.map((d) => (
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-xs font-semibold text-slate-800 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00B4D8]/20 focus:border-[#00B4D8]"
            />
          </div>
        ...
        <div className="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 px-5 py-2 rounded-xl bg-[#00B4D8] hover:bg-[#0096B4] text-white text-xs font-bold shadow-md shadow-[#00B4D8]/20 transition-all active:scale-95 disabled:opacity-60 cursor-pointer"
          >
            {loading ? (
              <>
      ...
      {summary && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <MetricCard
            ...
            icon={<Droplets className="w-5 h-5 text-[#00B4D8]" />}
          />
          ...
          <MetricCard
            ...
            icon={<TrendingUp className="w-5 h-5 text-[#0A1F44]" />}
          />
        </div>
      )}
      ...
      <div className="p-6 bg-white border border-slate-200 rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.05)] space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-100 pb-3">
          ...
          <div className="flex items-center gap-1 p-0.5 rounded-xl bg-slate-100 border border-slate-200 shadow-inner">
            ...
            <button
              ...
              className="p-1.5 rounded-lg bg-white text-slate-700 hover:text-[#00B4D8] shadow-xs border border-slate-200/50 transition-all cursor-pointer"
              title="Zoom In"
            >
        ...
        {!summary || summary.readingsCount === 0 ? (
          <div className="flex flex-col items-center justify-center h-[280px] border border-dashed border-slate-200 rounded-2xl bg-slate-50/50 p-6 text-center">
            <div className="p-3 rounded-full bg-slate-100 text-[#00B4D8] mb-2">
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={chartData} margin={{ top: 10, right: 15, left: -10, bottom: 0 }}>
                ...
                <Area
                  ...
                  dot={{ r: 3, fill: '#00B4D8', strokeWidth: 1, stroke: '#ffffff' }}
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <input
                ...
                className="pl-8 pr-3 py-1.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#00B4D8]/20 focus:border-[#00B4D8] w-44 sm:w-56"
              />
              ...
              <tbody className="divide-y divide-slate-100 text-xs text-slate-700">
                {paginatedRecords.map((record) => (
                  <tr key={record.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-3 px-4 text-right font-extrabold text-[#00B4D8]">
